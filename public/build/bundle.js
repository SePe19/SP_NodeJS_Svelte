...
var app = (function () {
    ...
    /* src\components\1_introduction\DynamicAttributes.svelte generated by Svelte v3.46.4 */

    const file$1 = "src\\components\\1_introduction\\DynamicAttributes.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			h1 = element("h1");
    			h1.textContent = `${/*name*/ ctx[1]}  ${/*action*/ ctx[2]}`;
    			if (!src_url_equal(img.src, img_src_value = /*src*/ ctx[0])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "" + (/*name*/ ctx[1] + " " + /*action*/ ctx[2]));
    			add_location(img, file$1, 6, 0, 223);
    			add_location(h1, file$1, 7, 0, 258);
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let src = 'https://media0.giphy.com/media/semLgqWI3U3qU/giphy.gif?cid=ecf05e474guowkynctabundp9097upm9t6rrfa97sinnxdn7&rid=giphy.gif&ct=g';
    	let name = 'Mosasaurus';
    	let action = 'feeding time';
    	...
    	$$self.$capture_state = () => ({ src, name, action });
    ...
    /* src\components\1_Introduction\1_Introduction.svelte generated by Svelte v3.46.4 */

    function create_fragment$1(ctx) {
    	let dynamicattributes;
    	let current;
    	dynamicattributes = new DynamicAttributes({ $$inline: true });
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			mount_component(dynamicattributes, target, anchor);
    			current = true;
    		},
    		p: noop,
    		...
    		d: function destroy(detaching) {
    			destroy_component(dynamicattributes, detaching);
    		}
    	};
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ DynamicAttributes, Hell: DynamicAttributes });
    	return [];
    }
    ...
    function create_fragment(ctx) {
    	...
    	let introduction;
    	let current;
    	introduction = new _1_Introduction({ $$inline: true });

    	const block = {
    		c: function create() {
    			main = element("main");
    			create_component(introduction.$$.fragment);
    			add_location(main, file, 6, 0, 107);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Introduction: _1_Introduction });
    	return [];
    }
